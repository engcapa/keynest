    ...
    <body>
      <div class="card">
        ...
        <ul style="margin-top: 24px">
          ...
          <li>POST /api/settings/test — test DB connection</li>
          <li>POST /api/settings/connect — connect to DB</li>
        </ul>
      </div>
    </body>
    </html>
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`MFA Vault API server running on port ${PORT}`);
});
